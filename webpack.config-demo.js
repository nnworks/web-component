...
module.exports = function(options) {
  ...
  // var wcHelperPlugin = new WcHelperPlugin({ removeChunks: Object.getOwnPropertyNames(entries).map((property) => property + ".js"), // remove the chunks generated by the html files
  //                                           supportLibsPath: options.supportLibsPath,
  //                                           webComponentBundles: options.webComponentBundles,
  //                                           supportBundles: options.supportBundles });

  // add webpacked-wc-helper.js (after instantiating the plugin, else this helper is allso filtered for emission)
  //entries["webpacked-wc-helper"] = "/home/pg63ux/workspaces/frontend-workspace/web-component/util/loaders/wc-helper-loader/webpacked-wc-helper.js";
